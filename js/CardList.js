...
class CardList {
    ...
    constructor({filterCategories, products}, Card, ColorOption,WattOpion,Favorite,More,Button) {
      ...
      _generateFilteredCards(data){
       ...
       .filter((obj) => {
          ...
          // подкрашивать titles (obj передать this._state.search)
            return new this._Card({...obj},this._ColorOption,this._WattOpion,this._Favorite,this._More,this._Button).element;
        });
      }
